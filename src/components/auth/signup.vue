    ...
    <div class="signup-form">
      <form @submit.prevent="onSubmit">
        <div class="input" :class="{invalid: $v.email.$error}">
          ...
          <p v-if="!$v.email.email">Please provide a valid email message</p>
        ...
        <div class="hobbies">
          ...
          <div class="hobby-list">
            ...
            <p v-if="!$v.hobbyInputs.minLen">You have to at least specify {{ $v.hobbyInputs.$params.minLen.min }} hobbies</p>
            <p v-if="!$v.hobbyInputs.required">Please add One hobby</p>
          </div>
        </div>
  ...
  validations: {
    email: {
      ...
      unique: val => {
        ...
        //   setTimeout(() => {
        //     resolve(val !== 'thafirstone@gmail.com')
        //   }, 1000)
        // })
      }
    },
